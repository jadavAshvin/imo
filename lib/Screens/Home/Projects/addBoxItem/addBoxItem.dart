import 'package:flt_imo/Controller/ProjectControllers/AddItemController.dart';
...
class AddBoxItem extends StatelessWidget {
  ...
  AddBoxItem({Key key, this.flag, this.screen}) : super(key: key);
  @override
              ...
              child: Stack(
                children: [
                  Container(
                    ...
                    height: 140,
                    child: Obx(() {
                      print("image path is ${addBoxesController.imageFile[0].path}");
                      return Stack(
                        children: [
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          //   controller.images.replaceRange(index, index + 1, ['Add Image']);
