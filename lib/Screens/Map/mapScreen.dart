                      ...
                      : Container(
                          child: InkWell(
                            onTap: () {
                              ...
                              setPrefValue(Keys.LETTITUDE, selectedPlace.geometry.location.lat.toString());
                              setPrefValue(Keys.LONGTITUDE, selectedPlace.geometry.location.lng.toString());
                              setPrefValue(Keys.ADDRESS, selectedPlace.formattedAddress);
                              Get.back(result: true);
                              // Get.back();
                              // Get.to(FilterMissions());
