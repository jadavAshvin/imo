...
/*---------------------------Boxes Api's-------------------------- */
Future<http.Response> boxesListApi() async {
  accessController.checkOnline();
  if (accessController.isOnline.value) {
    var client = http.Client();
    try {
      var response = await client.get(
        BASE_URL + PROJECT + AppConstants.PROJECT.id.toString() + PROJECT_BOXES,
...
Future<http.Response> addBoxesApi(body) async {
  ...
  if (accessController.isOnline.value) {
    ...
    try {
      ...
      print("Add Boxes Response: ${response.request.url}");
      print("Add Boxes Response: ${response.body}");
      return response;
    } catch (e) {
      print(e);
      return emptyRes;
...
// // ignore: missing_return
// Future<dio.Response> addBoxesApi(body) async {
//   accessController.checkOnline();
//   if (accessController.isOnline.value) {
...
//       final _result = await d.request<Map<String, dynamic>>(ADD_BOXES,
